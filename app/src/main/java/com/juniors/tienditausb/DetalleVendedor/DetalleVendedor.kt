package com.juniors.tienditausb.DetalleVendedor
...
import com.juniors.tienditausb.Comentarios
...
import com.juniors.tienditausb.databinding.ActivityDetalleVendedorBinding
        ...
        ref.child(uidVendedor)
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    val f_fecha = Costantes.obtenerFecha(tiempo_r)
