package com.juniors.tienditausb.DetalleAnuncio
...
import com.juniors.tienditausb.databinding.ActivityDetalleAnuncioBinding
...
class DetalleAnuncio : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Costantes.incrementarVistas(idAnuncio)
        ...
        binding.IbFav.setOnClickListener {
            if (favorito){
                //true
                Costantes.eliminarAnuncioFav(this, idAnuncio)
            }else{
                //false
                Costantes.agregarAnuncioFav(this,idAnuncio)
            }
        }
        ...
        binding.BtnMapa.setOnClickListener {
            Costantes.mapaIntent(this, anuncioLatitud, anuncioLongitud)
        }
        ...
        binding.BtnLlamar.setOnClickListener {
            if (ContextCompat.checkSelfPermission(applicationContext,
                ...
                if (numTel.isEmpty()){
                    ...
                    Costantes.llamarIntent(this, numTel)
                }
            }else{
        ...
        binding.BtnSms.setOnClickListener {
            if (ContextCompat.checkSelfPermission(applicationContext,
                ...
                if (numTel.isEmpty()){
                    ...
                    Costantes.smsIntent(this, numTel)
                }
            }else{
   ...
   /* private fun opcionesDialog() {
    ...
    private fun marcarAnuncioVendido(){
        ...
        hashMap["estado"] = "${Costantes.anuncio_vendido}"
        ...
        ref.child(uidVendedor)
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    val for_fecha = Costantes.obtenerFecha(tiempo_reg)
